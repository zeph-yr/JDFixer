...
- Added Reaction Time. Reaction time is a function of the map's original NJS and your Jump Distance.
...
This works exactly the same as JD Preferences. The four examples above apply, except in reaction time.
...
- **CustomCampaigns:** Supported. JD Slider and Preferences work as normal. Base game campaign also supported. Map display is disabled.
- **OST Levels:** Supported.
